...
// In your registration controller (adminController.js)
const registerAdmin = async (req, res) => {
  const { fullName, email, mobile, adminType, password } = req.body;
  // ...existing validation...

  // Save adminType as received from frontend
  const newAdmin = new AdminModel({
    fullName,
    email,
    mobile,
    adminType, // This will be "Administrator", "Technical Admin", or "Customer Service Admin"
    password: hashedPassword,
    // ...other fields...
  });
